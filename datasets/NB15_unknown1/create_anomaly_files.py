...
anomaly_types = ["Fuzzers", "Generic", "Reconnaissance", "Analysis", "Backdoors", "DoS", "Exploits"]
...
for at in anomaly_types:
    ...
    combined_data = combined_data[[c for c in combined_data if c not in ['Label']] + ['Label']]
